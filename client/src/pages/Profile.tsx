                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  {activeTab === 'documents' && (
                    <div className="space-y-6">
                      ...
                      {/* Document Cards - Based on screenshot layout */}
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {/* ID Document */}
                        <div className="border border-dashed rounded-lg p-6 hover:border-blue-400 transition-colors">
                          <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-sm text-gray-500 mt-2">
                              Upload a copy of your ID document or passport
                            </p>
                            <Button className="mt-4" variant="outline">Upload</Button>
                          </div>
                        </div>
                        ...
                        <div className="border border-dashed rounded-lg p-6 hover:border-blue-400 transition-colors">
                          <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-sm text-gray-500 mt-2">
                              Upload your last 3 months of payslips
                            </p>
                            <Button className="mt-4" variant="outline">Upload</Button>
                          </div>
                        </div>
                      ...
                      <div className="mt-8">
                        ...
                        {/* No Documents State - Matching the design in the screenshot */}
                        <div className="bg-gray-50 border border-gray-100 p-8 rounded-lg">
                          <div className="flex flex-col items-center justify-center text-center">
                            ...
                            <h4 className="text-lg font-medium text-gray-700">No documents uploaded yet</h4>
                      ...
                      {/* No need for a save button here as it's already at the bottom of the form */}
                    </div>
                  )}
